...
class RegistrationProvider extends ChangeNotifier {
  ...
  void updateRegistrant(String id, String name, String email, String programStudi) {
    final index = _registrants.indexWhere((r) => r.id == id);

    if (index != -1) {
      _registrants[index] = _registrants[index].copyWith(
        name: name,
        email: email,
